...
public class MainActivity extends Activity {
    ...
    private void installAICoderRuntime(){String cmd="pkg install -y python git && python -m pip install --upgrade pip && python -m pip install --upgrade --force-reinstall 'git+https://github.com/derleiti/ai-coder.git' && aicoder --version";runTermux(cmd,"Installing AICoder runtime");}
