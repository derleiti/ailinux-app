...
contextBridge.exposeInMainWorld('ailinuxHelper', Object.freeze({
  aicoderStatus: () => ipcRenderer.invoke('ailinux-app:aicoder-status'),
  launchAICoder: () => ipcRenderer.invoke('ailinux-app:aicoder-launch'),
  stopAICoder: () => ipcRenderer.invoke('ailinux-app:aicoder-stop'),
