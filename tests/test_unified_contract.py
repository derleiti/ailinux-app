...
class UnifiedAppContractTests(unittest.TestCase):
    ...
    def test_android_is_upgrade_compatible_and_unified(self) -> None:
        ...
        self.assertIn("versionName '3.0.0-alpha.6'", gradle)
    ...
    def test_linux_source_launcher_and_assets(self) -> None:
        ...
        self.assertIn('AILINUX_LOOM_ROOT', run_source)
        self.assertIn('-m ailinux_suite --root "$LOOM" gui', run_source)
        self.assertIn('AILINUX_APP_LEGACY_AICODER', run_source)
